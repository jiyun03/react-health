...
function View() {
  ...
  const deleteHandler = () => {
    ...
    setDimOpen(true)
    const response = fetch(`https://react-health-ef569-default-rtdb.firebaseio.com/healthList/year${year}/month${month}/${viewKey[2]}.json`, {
      method: "DELETE",
    })
    return response
  }
        ...
        <div className="view">
          <div className="view__head">
            ...
            <div className="view__icon-wrap">
              <div className="view__icon" onClick={() => {toolkit.current.classList.toggle("s-active")}}>
                <img src={`${publicFolder}/assets/img/icon/ellipsis.png`} alt="툴팁 아이콘" />
              </div>
              <div className="view__tooltip-wrap" ref={toolkit}>
                <NavLink to={`/write?key=${viewKey[2]}&year=${year}&month=${month}`}  className="view__tooltip">
                  수정
                </NavLink>
          ...
          <div className="view__detail">
            ...
            <div className="view__detail-item">
              ...
              <div className="view__detail-content">
                ...
                {View.medicineInput && <div className="view__detail-detail">{View.medicineInput}</div>}
              </div>
            </div>
            <div className="view__detail-item">
              ...
              <div className="view__detail-content">
                {View.shot === "yes" ? "예" : "아니오"}
                {View.shotInput && <div className="view__detail-detail">{View.shotInput}</div>}
              </div>
            </div>
          </div>
